...
export function executeCodeParameters(): Record<string, unknown> {
    return {
        type: "object",
        ...
        properties: {
            language: {
                ...
                description: "Language runtime to use. Availability is detected when the tool is called.",
            },
            ...
            file: {
                type: "string",
                description: "Path to a source/script file to execute. Mutually exclusive with code."
            },
            args: {
                type: "array",
                items: {type: "string"},
                description: "Arguments passed to the executed program/script."
            },
