...
export const agentEnvDescriptions = {
  ...
  [agentEnv.policyDefaults]: "JSON session overrides for unmatched policy defaults inherited by subagents.",
  [agentEnv.subagentToolkitCeiling]: "Comma-separated list of subagent toolkits nested subagents may use at most.",
